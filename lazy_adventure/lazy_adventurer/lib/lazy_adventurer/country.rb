...
doc = Nokogiri::HTML(open("https://www.lonelyplanet.com/canada"))
#  doc = Nokogiri::HTML(open("url"))
#  url = doc.css('div#introduction p').attr('href').text
...
binding.pry
  @summary = doc.css('span.js-intro-narrative p').text
   titles = doc.css('h2.intro-narrative__title').to_a
    ...
    titles = titles.each{|title| title.text}
